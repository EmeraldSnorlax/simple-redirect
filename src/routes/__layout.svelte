  ...
  <div class="bg-true-gray-800 rounded-md shadow-lg">
    <div class="p-4">
      ...
      <p class="text-true-gray-300 text-center text-xl my-2">
        The new location for this content is <a
          href="https://snorlax.sh/">snorlax.sh</a
        >
      </p>
...
<footer class="absolute bottom-0 text-true-gray-300 bg-true-gray-800 w-full lg:flex lg:items-center lg:justify-between p-4">
